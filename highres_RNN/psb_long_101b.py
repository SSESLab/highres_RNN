...
train_data2 = numpy.reshape(train_data2, (X_day_t.shape[0], int(seq_time/std_inv2), train_data2.shape[1]))
val_data2 = numpy.reshape(val_data2, (X_day_val.shape[0], int(seq_time/std_inv2), val_data2.shape[1]))
test_data2 = numpy.reshape(test_data2, (X_day_e.shape[0], int(seq_time/std_inv2), test_data2.shape[1]))
H_t2 = numpy.reshape(H_t2, (H_mean_t.shape[0], int(seq_time/std_inv2), H_t2.shape[1]))
H_val2 = numpy.reshape(H_val2, (H_mean_v.shape[0], int(seq_time/std_inv2), H_val2.shape[1]))
H_e2 = numpy.reshape(H_e2, (H_mean_e.shape[0], int(seq_time/std_inv2), H_e2.shape[1]))
...
def objective(params):
    optimize_model = build_lstm_v1.lstm_multi_104(params, train_data2.shape[2], H_t2.shape[2], (seq_time/std_inv2)) #Check code here, relu entering
...
numpy.save('HVAC1b_10min2A.npy', Y_lstm)
numpy.save('HVAC1b_val.npy', Y_val)
