...
def objective(params):
    optimize_model = build_lstm_v1.lstm_model_110(params, train_data2.shape[2], tsteps2) #Check code here, relu entering
...
numpy.save('HVAC_critical_10min0.npy', Y_lstm2)
