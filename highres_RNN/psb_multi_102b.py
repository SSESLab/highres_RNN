...
print "Frequency troubleshoot"
print T_sch_t.shape
print T_sch_t2.shape
print T_sch_t[0:20]
print T_sch_t2[0:20]
...
numpy.save('Ht2_CRAC2.npy', H1)
numpy.save('Hv2_CRAC2.npy', H2)
numpy.save('He2_CRAC2.npy', H3)
...
####Saving block
#numpy.save('CRAC_critical_10min2A.npy', Y_lstm)
#numpy.save('CRAC2_val.npy', Y_val)
...
#numpy.save('CRAC_critical_10minMLP.npy', Y_NN)
