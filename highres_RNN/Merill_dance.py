...
folder_path = r'/home/sseslab/PycharmProjects/ElectricLoad_v1/Merill_Dance/train_data'
...
if choice == 1:
    H_t = numpy.load('Ht_file_MD1.npy')
elif choice == 2:
    ...
    numpy.save('Ht_file_MD1.npy', H_t)
else:
    H1 = H_t.copy()
...
folder_path = r'/home/sseslab/PycharmProjects/ElectricLoad_v1/Merill_Dance/test_data'
data = DataFunctions_2.read_multiple_files(folder_path, 1, 2)
...
numpy.save('MD1_B.npy', Y_lstm2)
numpy.save('MD1_NN.npy', Y_NN)
