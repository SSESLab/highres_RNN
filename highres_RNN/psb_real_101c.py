...
data = DataFunctions.read_PSB_csv(date_start, date_end, 5, 20) #read data at 5 min resolutions
conv_critical, crac_critical, crac_normal, conv_normal, HVAC_critical, Elev, HVAC_normal, elec_total = DataFunctions.PSB_elec_split(data) #split by end uses
H_val2 = DataFunctions.prepare_energy_PSB(conv_normal, std_inv2) #Energy Consumption Data for multi timescale analysis
...
#val_data2 = numpy.concatenate((X_sch_val2, x_v2), axis=1)
...
data = DataFunctions.read_PSB_csv(date_start, date_end, 5, 20) #read data at 5 min resolutions
conv_critical, crac_critical, crac_normal, conv_normal, HVAC_critical, Elev, HVAC_normal, elec_total = DataFunctions.PSB_elec_split(data) #split by end uses
H_e2 = DataFunctions.prepare_energy_PSB(conv_normal, std_inv2) #Energy Consumption Data for multi timescale analysis
...
#test_data2 = numpy.concatenate((X_sch_e2, x_e2), axis=1)
...
numpy.save('CONV_normal_10min2B0.npy', Y_lstm)
numpy.save('CONV2B_val0.npy', Y_val)
