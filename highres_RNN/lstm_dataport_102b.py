...
file_ = r'~/PycharmProjects/ElectricLoad_v1/dataport_data/dataport26.csv'
...
file_ = r'~/PycharmProjects/ElectricLoad_v1/dataport_data/dataport26_1min.csv'
...
file_ = r'~/PycharmProjects/ElectricLoad_v1/dataport_data/dataport26b.csv'
H_e, dummy = DataFunctions.preprocess_energyData_101(file_)
H_e = H_e/H_max1
file_ = r'~/PycharmProjects/ElectricLoad_v1/dataport_data/dataport26b_1min.csv'
...
PlotFunctions.Plot_double(t_array, H_e, t_array, Y_hour, 'Actual conv power','LSTM conv power', 'k-', 'r-', "fig_26i1a.eps")
numpy.save('Y_hour26.npy', Y_hour)
numpy.save('Y_lstm26.npy', Y_lstm2)