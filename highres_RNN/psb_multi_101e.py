...
def objective(params):
    optimize_model = build_lstm_v1.lstm_multi_107e(params, train_data2.shape[2], H_t2.shape[2], (std_inv/std_inv2)) #Check code here, relu entering
...
#Building model
lstm_model = build_lstm_v1.lstm_multi_107e(lstm_hidden, train_data2.shape[2], H_t2.shape[2], tsteps2)
...
####Saving block
numpy.save('HVAC_critical_10min2D0.npy', Y_lstm)
