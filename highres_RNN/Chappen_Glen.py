...
folder_path = r'/home/sseslab/PycharmProjects/ElectricLoad_v1/chapel_glen_gas/train_data'
...
if choice == 1:
    H_t = numpy.load('Ht_file_GC1.npy')
elif choice == 2:
    ...
    numpy.save('Ht_file_GC1.npy', H_t)
else:
    H1 = H_t.copy()
    ...
    print e_NN
    H_t = Y_t.copy()
    numpy.save('H1_file_GC1.npy', H_t)
...
folder_path = r'/home/sseslab/PycharmProjects/ElectricLoad_v1/chapel_glen_gas/test_data'
data = DataFunctions_2.read_multiple_files(folder_path, 1, 2)
...
#Saving files
numpy.save('Ht_MD1.npy', H_t)
numpy.save('Hv_MD1.npy', H_val)
numpy.save('He_MD1.npy', H_e)
...
space = {
        ...
        'activ_l4': hp.choice('activ_l4', ['tanh', 'sigmoid'])
         }
...
numpy.save('Ht_GC1.npy', H_t)
numpy.save('Hv_GC1.npy', H_val)
numpy.save('He_GC1.npy', H_e)
numpy.save('GC1_B.npy', Y_lstm2)
numpy.save('GC1_NN.npy', Y_NN)
