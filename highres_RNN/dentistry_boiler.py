...
folder_path = r'/home/sseslab/PycharmProjects/ElectricLoad_v1/dentistry_bldg/boiler_train'
data = DataFunctions_2.read_multiple_files(folder_path, 1, 4)
H_t = DataFunctions_2.denstry_bldg_101(data)
...
if choice == 1:
    H_t = numpy.load('Ht_file_Boiler1.npy')
elif choice == 2:
    ...
    numpy.save('Ht_file_Boiler1.npy', H_t)
else:
    H1 = H_t.copy()
    ...
    print e_NN
    H_t = Y_t.copy()
    numpy.save('H1_file_Boiler1.npy', H_t)
...
date_end = '01/31/17 11:59 PM'

folder_path = r'/home/sseslab/PycharmProjects/ElectricLoad_v1/dentistry_bldg/boiler_test'
data = DataFunctions_2.read_multiple_files(folder_path, 1, 4)
H_e = DataFunctions_2.denstry_bldg_101(data)
...
#Saving files
numpy.save('Ht_dentistry_boiler.npy', H_t)
numpy.save('Hv_dentistry_boiler.npy', H_val)
numpy.save('He_dentistry_boiler.npy', H_e)

numpy.save('dentistry_boiler_B.npy', Y_lstm2)
numpy.save('dentistry_boiler_NN.npy', Y_NN)
