...
numpy.save('3_train.npy', H_t)
numpy.save('3_val.npy', H_val)
...
numpy.save('3_test.npy', H_e)

##Saving data
numpy.save('H_t10.npy', H_t)
numpy.save('H_e10.npy', H_e)
numpy.save('H_t210.npy', H_t2)
numpy.save('H_e210.npy', H_e2)
...
for i in range(0, len(test_data2)):
    #for ep in range(0, 5):
     ...
     Y_temp = H_e2[i, :]
     Y_temp = Y_temp[None, :]
     lstm_history = save_model.fit(X_temp, Y_temp, batch_size=1, nb_epoch=1, validation_split=0, shuffle=False)
