...
file_ = r'/home/sseslab/Documents/dataport_data/dataport26_1min.csv'
...
file_ = r'/home/sseslab/Documents/dataport_data/dataport26b_1min.csv'
...
for i in range(0, len(test_data2)):
    #for ep in range(0, 5):
     ...
     Y_temp = H_e2[i, :]
     Y_temp = Y_temp[None, :]
     lstm_history = save_model.fit([X_temp,  h_temp], Y_temp, batch_size=1, nb_epoch=5, validation_split=0, shuffle=False)
