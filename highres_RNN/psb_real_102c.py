...
train_data2 = numpy.concatenate((weather_train2[:, 0:2], X_sch_t2, x_t2, T_sch_t2), axis=1)
#train_data2 = numpy.concatenate((X_sch_t2, x_t2), axis=1)
...
print weather_val2.shape
print X_sch_val2.shape
print T_sch_val2.shape
print x_v2.shape

#val_data2 = numpy.concatenate((weather_val2[:, 0:2], X_sch_val2, x_v2), axis=1)
val_data2 = numpy.concatenate((weather_val2[:, 0:2], X_sch_val2, x_v2, T_sch_val2), axis=1)
...
def objective(params):
    optimize_model = build_lstm_v1.lstm_multi_107(params, train_data2.shape[2], (std_inv/std_inv2)) #Check code here, relu entering
...
#Building model
lstm_model = build_lstm_v1.lstm_multi_107(lstm_hidden, train_data2.shape[2],  tsteps2)
...
numpy.save('CRAC_normal_10min2B0.npy', Y_lstm)
numpy.save('CRAC2B_val0.npy', Y_val)
